<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<SMS.Models.DomainModels.Team>" %>
    ...
    <% using (Html.BeginForm())
       {
         ...
         <h1>
            ...
            <%: Model.Name + "(Category - " + Model.Category + ")" %>
            team?</h1>
